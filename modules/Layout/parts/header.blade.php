            ...
            <div class="hidden xl:flex items-center gap-6">
                ...
                <div class="relative" @mouseenter="serviceOpen = true" @mouseleave="serviceOpen = false; serviceTrainingOpen = false">
                    ...
                    <div x-show="serviceOpen" x-transition.origin.top.duration.150ms
                        ...
                        <a href="{{ route('services.crew-abandonment') }}" class="block px-5 py-3 text-[12px] font-semibold uppercase tracking-[0.08em] text-white/75 hover:text-white hover:bg-white/10 transition-colors">Solution to Crew Abandonment</a>
                ...
                <div class="space-y-1">
                    ...
                    <div>
                        ...
                        <div x-show="mServiceOpen" x-transition class="pl-4 space-y-1 mt-1" x-cloak>
                            ...
                            <a href="{{ route('services.crew-abandonment') }}" @click="mobileMenuOpen = false" class="block rounded-[10px] px-4 py-2.5 text-sm font-semibold uppercase tracking-[0.08em] text-white/70 hover:bg-white/10 hover:text-white transition-colors">Solution to Crew Abandonment</a>
