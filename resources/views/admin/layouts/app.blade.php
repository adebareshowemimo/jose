...
<body class="bg-gray-50 min-h-screen" x-data="{ sidebarOpen: false }">
    ...
    <aside class="fixed top-0 left-0 w-64 h-full bg-[#0A1929] z-50 lg:translate-x-0"
        ...
        <nav class="p-4 space-y-1 overflow-y-auto" style="height: calc(100vh - 4rem);">
            ...
            {{-- Boost Settings --}}
            <a href="{{ route('admin.boosts.settings.index') }}"
               class="flex items-center gap-3 px-3 py-2.5 text-sm font-medium rounded-lg transition
               {{ str_starts_with($current, 'admin.boosts.settings') ? 'bg-[#1AAD94] text-white' : 'text-white/60 hover:text-white hover:bg-white/5' }}">
            ...
            <a href="{{ route('admin.training-categories.index') }}"
               class="flex items-center gap-3 px-3 py-2.5 text-sm font-medium rounded-lg transition
               {{ str_starts_with($current, 'admin.training-categories.') ? 'bg-[#1AAD94] text-white' : 'text-white/60 hover:text-white hover:bg-white/5' }}">
            ...
            {{-- Contract Staffing --}}
            <a href="{{ route('admin.contract-staffing.index') }}"
               class="flex items-center gap-3 px-3 py-2.5 text-sm font-medium rounded-lg transition
            ...
            {{-- Contact Routing --}}
            <a href="{{ route('admin.contact-routing.index') }}"
               class="flex items-center gap-3 px-3 py-2.5 text-sm font-medium rounded-lg transition
               {{ str_starts_with($current, 'admin.contact-routing') ? 'bg-[#1AAD94] text-white' : 'text-white/60 hover:text-white hover:bg-white/5' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 8a2 2 0 00-2-2H5a2 2 0 00-2 2m18 0v10a2 2 0 01-2 2H5a2 2 0 01-2-2V8m18 0L13.46 12.74a2 2 0 01-2.92 0L3 8"/></svg>
                Contact Routing
            </a>
            ...
            <a href="{{ route('admin.currency.index') }}"
               class="flex items-center gap-3 px-3 py-2.5 text-sm font-medium rounded-lg transition
               {{ str_starts_with($current, 'admin.currency') ? 'bg-[#1AAD94] text-white' : 'text-white/60 hover:text-white hover:bg-white/5' }}">
            ...
            <a href="{{ route('admin.settings.index') }}"
               class="flex items-center gap-3 px-3 py-2.5 text-sm font-medium rounded-lg transition
               {{ (str_starts_with($current, 'admin.settings') && ! str_starts_with($current, 'admin.currency')) ? 'bg-[#1AAD94] text-white' : 'text-white/60 hover:text-white hover:bg-white/5' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
                Settings
            </a>
        </nav>
