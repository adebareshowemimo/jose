...
@section('content')
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        <div class="bg-white rounded-xl border border-gray-200 p-5 min-w-0">
            ...
            <p class="text-xl sm:text-2xl font-bold text-gray-900 break-words">{{ number_format($totalUsers) }}</p>
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-5 min-w-0">
            ...
            <p class="text-xl sm:text-2xl font-bold text-gray-900 break-words">{{ number_format($totalCompanies) }}</p>
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-5 min-w-0">
            ...
            <p class="text-xl sm:text-2xl font-bold text-gray-900 break-words">{{ number_format($totalJobs) }}</p>
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-5 min-w-0">
            ...
            <p class="text-xl sm:text-2xl font-bold text-gray-900 break-words">{{ money($totalRevenue, \App\Support\Currency::default()) }}</p>
    ...
    <div class="grid grid-cols-3 gap-4 mb-6">
        <div class="bg-white rounded-xl border border-gray-200 p-5 min-w-0 text-center">
            <p class="text-2xl sm:text-3xl font-bold text-[#073057] break-words">{{ number_format($totalCandidates) }}</p>
            <p class="text-sm text-gray-500 mt-1">Candidates</p>
        </div>
        <div class="bg-white rounded-xl border border-gray-200 p-5 min-w-0 text-center">
            <p class="text-2xl sm:text-3xl font-bold text-[#073057] break-words">{{ number_format($pendingJobs) }}</p>
            <p class="text-sm text-gray-500 mt-1">Pending Jobs</p>
        </div>
        <div class="bg-white rounded-xl border border-gray-200 p-5 min-w-0 text-center">
            <p class="text-2xl sm:text-3xl font-bold text-[#073057] break-words">{{ number_format($activeSubscriptions) }}</p>
    ...
    <div class="grid lg:grid-cols-2 gap-6">
        {{-- Recent Users --}}
        <div class="bg-white rounded-xl border border-gray-200 min-w-0">
