...
@section('content')
    <div class="mb-6 flex flex-wrap items-end justify-between gap-4">
        ...
        <div class="flex items-center gap-3">
            ...
            <a href="{{ route('admin.events.create') }}" class="inline-flex items-center gap-2 px-4 py-2.5 bg-[#1AAD94] hover:brightness-110 text-white text-sm font-bold uppercase tracking-widest rounded-lg shadow transition">
            ...
            <div class="space-y-3">
                    ...
                    <div class="bg-white rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition overflow-hidden" x-data="{ editing: false }">
                        <div class="flex flex-col sm:flex-row gap-4 p-4">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="text-sm text-gray-600 leading-relaxed line-clamp-2 mb-3">{{ \Illuminate\Support\Str::limit(strip_tags((string) $event->description), 180) }}</p>
                                ...
                                <div class="pt-3 border-t border-gray-100 flex flex-wrap items-center justify-between gap-3 text-xs text-gray-500">
                                    ...
                                    <div class="flex items-center gap-1">
                                        <a href="{{ route('admin.events.show', $event) }}" class="inline-flex items-center gap-1 px-2.5 py-1 rounded-md font-semibold {{ $event->reminders_enabled ? 'text-[#1AAD94] hover:bg-[#1AAD94]/10' : 'text-gray-600 hover:bg-gray-100' }}" title="Details & email reminders">
                                            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"/></svg>
                                            Reminders
                                        </a>
                                        <a href="{{ route('admin.events.registrations', $event) }}" class="inline-flex items-center gap-1 px-2.5 py-1 rounded-md text-[#073057] hover:bg-[#073057]/10 font-semibold" title="View attendees">
                ...
                @empty
                    <div class="bg-white rounded-xl border border-dashed border-gray-300 p-12 text-center">
                        ...
                        <p class="text-sm text-gray-500 mb-4">No events yet.</p>
                        <a href="{{ route('admin.events.create') }}" class="inline-flex items-center gap-2 px-4 py-2 bg-[#1AAD94] hover:brightness-110 text-white text-sm font-bold uppercase tracking-widest rounded-lg shadow transition">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M12 6v6m0 0v6m0-6h6m-6 0H6"/></svg>
