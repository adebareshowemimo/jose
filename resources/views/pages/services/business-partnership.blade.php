...
<section class="relative h-[400px] flex items-center overflow-hidden bg-[#073057]">
    @if (!empty($img['business_partnership_hero']))
        <img src="{{ $img['business_partnership_hero'] }}" alt="Business Partnerships" class="absolute inset-0 w-full h-full object-cover opacity-40" loading="eager" />
    @endif
    ...
    <div class="container mx-auto px-6 relative z-10">
        ...
        <h1 class="text-[32px] sm:text-[48px] md:text-[64px] font-extrabold text-white leading-none">Business Partnerships</h1>
    ...
    <div class="container mx-auto px-6">
        <div class="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div class="relative rounded-[32px] overflow-hidden shadow-xl bg-gradient-to-br from-[#073057] via-[#0a4275] to-[#1AAD94] min-h-[480px]">
                @if (!empty($img['business_partnership_hero']))
                    <img src="{{ $img['business_partnership_hero'] }}" alt="Business Partnerships" class="absolute inset-0 w-full h-full object-cover" loading="lazy" />
                @endif
            </div>
        </div>
    </div>
