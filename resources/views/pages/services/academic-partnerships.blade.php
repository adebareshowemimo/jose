...
<section class="relative h-[400px] flex items-center overflow-hidden bg-[#073057]">
    @if (!empty($img['crew_management']))
        <img src="{{ $img['crew_management'] }}" alt="Academic Partnerships" class="absolute inset-0 w-full h-full object-cover opacity-40" loading="eager" />
    @endif
    ...
    <div class="container mx-auto px-6 relative z-10">
        ...
        <h1 class="text-[48px] md:text-[64px] font-extrabold text-white leading-none">Academic Partnerships</h1>
        ...
        <div class="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div class="rounded-[32px] overflow-hidden shadow-xl bg-gradient-to-br from-[#073057] via-[#0a4275] to-[#1AAD94] min-h-[480px] flex items-center justify-center text-white">
                <div class="text-center p-12">
                    <iconify-icon icon="lucide:graduation-cap" class="text-7xl mb-4 opacity-80"></iconify-icon>
                    <p class="text-lg font-bold uppercase tracking-[0.15em] opacity-80">Where academia meets industry</p>
                </div>
            </div>
        </div>
    </div>
