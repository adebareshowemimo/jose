    ...
    class RunUpdater
    {
        ...
        public function updateTo120(){
            ...
            if($candidate = \Modules\User\Models\Role::query()->where('name','candidate')->first()){
                ...
                $candidate->save();
                $candidate->givePermission(['candidate_manage','media_upload']);
            }
        ...
        public function updateTo300(){
            $version = 'update_to_3_0_1';
            if (setting_item($version)) {
                return false;
            }
            Artisan::call('migrate', [
        ...
        public function updateTo251()
        {
            $version = 'update_to_251.1';
            if (setting_item($version)) {
                return false;
            }
            Artisan::call('migrate', [
